 ...
 * @author carli
 */
public class PanelCancionesFavoritas extends javax.swing.JPanel {
     ...
     */
    public PanelCancionesFavoritas(FrmPrincipal frmPrincipal1) {
        initComponents();
    ...
    public PanelCancionesFavoritas(FrmPrincipal frmPrincipal1, String filtro, FiltroMusicaDTO filtroMusica, boolean fechaLanzamiento) {
        initComponents();
    ...
    private void initComponents() {
        ...
        panelCanciones1 = new javax.swing.JPanel();
        panelCanciones2 = new javax.swing.JPanel();
        ...
        panelCanciones1.setBackground(new java.awt.Color(27, 26, 26));
        panelCanciones1.setPreferredSize(new java.awt.Dimension(750, 1000));
        jPanel3.add(panelCanciones1);

        panelCanciones2.setBackground(new java.awt.Color(27, 26, 26));
        panelCanciones2.setPreferredSize(new java.awt.Dimension(750, 1000));
        jPanel3.add(panelCanciones2);
    ...
    public void buscarCanciones(String filtro){
        ...
        try {
            ...
            if(filtroMusica == null)
                for(CancionDoc cancion : frmPrincipal.getLoggedUser().getFavoritos().getCanciones()){

                    if(cancion.getNombre().startsWith(filtro))
            ...
            for(CancionDoc cancionD : frmPrincipal.getLoggedUser().getFavoritos().getCanciones()){
                
                esEspecificado = false;
                
                AlbumDTO cancionA = new AlbumDTO();
                cancionA.setCanciones(Arrays.asList(cancionD));
                try {
                    for(GeneroDTO genero : frmPrincipal.albumNegocio.obtenerAlbumPorCancion(cancionA).getArtista().getGeneros())
                ...
                if(cancionD.getNombre().startsWith(filtro))
                    if(esEspecificado)
                        canciones.add(cancionD);
            }
            ...
            for(CancionDoc cancionContador : canciones){
                    
                    cancionesDesplegadas.add(cancionContador);
                    cantidadCanciones++;
            ...
            //Iteramos por cada album que nos regresa
                ...
                for(CancionDoc cancion : canciones){
                    
                    AlbumDTO album3mil = new AlbumDTO();
                    album3mil.setCanciones(Arrays.asList(cancion));
